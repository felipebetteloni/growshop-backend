...
import { ChatUpdateManyWithoutUserFromNestedInput } from '../chat/chat-update-many-without-user-from-nested.input';
...
@InputType()
export class UserUpdateWithoutSubscriptionsInput {
    ...
    @Field(() => ChatUpdateManyWithoutUserFromNestedInput, {nullable:true})
