...
import { StateCreateNestedOneWithoutProductsInput } from '../state/state-create-nested-one-without-products.input';
...
@InputType()
export class ProductCreateWithoutNeighbourhoodInput {
    ...
    @Field(() => StateCreateNestedOneWithoutProductsInput, {nullable:true})
