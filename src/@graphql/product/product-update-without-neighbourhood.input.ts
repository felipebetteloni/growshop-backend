...
import { FavoriteUpdateManyWithoutProductNestedInput } from '../favorite/favorite-update-many-without-product-nested.input';
...
@InputType()
export class ProductUpdateWithoutNeighbourhoodInput {
    ...
    @Field(() => FavoriteUpdateManyWithoutProductNestedInput, {nullable:true})
